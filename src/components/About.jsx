...
import embeddedImage from '../assets/embedded.webm';
import robotImage from '../assets/robot.webm';
import autoImage from '../assets/automation.webm';
import problemImage from '../assets/problem.webm';
            ...
            <AnimatePresence mode="wait">
              ...
              {hoveredSkill ? (
                ...
                >
                  ...
                  <h3 className="text-xl md:text-2xl font-bold text-white mb-4 md:mb-6 relative z-10 p-2 md:p-0">
